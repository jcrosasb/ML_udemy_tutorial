...
class PreprocessingPipe:
    ...
    def rearrange_pipe(self, names=None, filename=None, remove_nan=None):
        ...
        # Place non-feature columns at the beginning
        df = pd.concat([df.iloc[:, -num_non_feature:], df.iloc[:, :-num_non_feature]], axis=1)
...
if __name__ == '__main__':
    ...
    # df2 = pd.read_csv('data/data_creg.csv')

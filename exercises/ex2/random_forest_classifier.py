...
class RdmForestClassifier:

    def __init__(self, data, independent, dependent, parameters={'n_estimators': 10, 'criterion': 'entropy', 'random_state': 0}, \
                 size:float=0.2, seed:int=42) -> None:
        '''Initializer of RdmForestClassifier object.
           Attributes and parameters:
                ...
                * parameters: (Dict) RdmForestClassifier parameters. Default values are 
                              n_estimators, criterion and random_state. 
                              See RandomForestClassifier documentation for more information.
    ...
    def _split_dataset_for_training(self, size:float, seed:int):
        '''Method to split datatset into training and testing. The method is ran
           automatically when a RdmForestClassifier object is created.
           Parameters:
                * size: (Integer) the proportion of the file that will 
                        be used for testing
    ...
    def _train_model(self):
        '''Method to train model using method 'fit'. The method is ran
           automatically when a RdmForestClassifier object is created.'''
        self.trained_model = RandomForestClassifier(**self.parameters)
...
if __name__ == '__main__':
    ...
    # Instantiate RdmForestClassifier
    classifier = RdmForestClassifier(data=prep_df.sample(n=1000, random_state=42),
                                   independent=indep,
                                   dependent=dep)

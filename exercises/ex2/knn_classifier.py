...
class KnnClassifier:
    ...
    def __init__(self, data, independent, dependent, parameters={'n_neighbors':5, 'metric': 'minkowski', 'p': 2}, \
        ...
        '''Initializer of LogRegression object.
           Attributes and parameters:
                ...
                * parameters: (Dict) KNeighborsClassifier parameters. Default values are 
                              n_neighbors and metric. See KNeighborsClassifier documentation for more information.
    ...
    def _split_dataset_for_training(self, size:float, seed:int):
        '''Method to split datatset into training and testing. The method is ran
           automatically when a KnnClassifier object is created.
           Parameters:
                * size: (Integer) the proportion of the file that will 
                        be used for testing
    ...
    def _train_model(self):
        '''Method to train model using method 'fit'. The method is ran
           automatically when a KnnClassifier object is created.'''
        self.trained_model = KNeighborsClassifier(**self.parameters)
...
if __name__ == '__main__':
    ...
    classifier = KnnClassifier(data=prep_df.sample(n=10000, random_state=42),
                                   independent=indep,
                                   dependent=dep)
    ...
    # plot.logistic(coef=regressor.get_coefficients())

...
class SvmKernelClassifier:
    ...
    def __init__(self, data, independent, dependent, parameters={'kernel': 'rbf','random_state': 0}, \
                 size:float=0.2, seed:int=42) -> None:
        '''Initializer of SvmKernelClassifier object.
           Attributes and parameters:
                ...
                * parameters: (Dict) SvmKernelClassifier parameters. Default values is
    ...
    def _train_model(self):
        '''Method to train model using method 'fit'. The method is ran
           automatically when a SvmClassifier object is created.'''
        self.trained_model = SVC(**self.parameters)
...
if __name__ == '__main__':
    ...
    # Instantiate SvmKernelClassifier
    classifier = SvmKernelClassifier(data=prep_df.sample(n=10000, random_state=42),
                                   independent=indep,
                                   dependent=dep)
